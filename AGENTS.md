...
Use this file as the Codex-facing repo instruction stub.

- Read `CLAUDE.md` for the main repository guidance, architecture, commands, invariants, and verification flow.
